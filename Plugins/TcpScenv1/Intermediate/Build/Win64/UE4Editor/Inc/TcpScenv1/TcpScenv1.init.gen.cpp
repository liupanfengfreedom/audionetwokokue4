...
void EmptyLinkFunctionForGeneratedCodeTcpScenv1_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_TcpScenv1()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_TcpScenv1_OnLogInsucceed__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_TcpScenv1_OnFileReceiveSucceed__DelegateSignature,
			};
